...
In the case study, these RBS systems are investigated and compared: (a) three different structures (Figs. \ref{fig:study-stru-Visairo}-\ref{fig:study-stru-my}) with the same four batteries; (b) the same structure in Figs. \ref{fig:study-stru-my} with two/four/six batteries; and (c) the four-battery structure in Figs. \ref{fig:study-stru-my} with random isolated batteries. 
...
The other algorithms' parameters are set as shown in Tab. \ref{tab:algorithm-parameter}.
...
To verify and compare the proposed greedy algorithm, we also used the brute-force algorithm, which iterates through all possible switch states, and heuristic algorithms (SA and GA) to calculate the MAC of the same three RBSs. 
...
The two heuristic algorithms' temporal variation of the objective values during the iteration process are shown in Figs. \ref{fig:e4-alg}, \ref{fig:f4-alg}, and \ref{fig:e2f2-alg}, respectively, compared with the greedy algorithm.
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        ...
        \label{fig:e2f2-alg}
    \end{subfigure}
    \caption{The temporal variation of the objective values during the iteration process of calculating the RBS structures in (a) Fig. \ref{fig:study-stru-Lawson}, (b) Fig. \ref{fig:study-stru-Visairo}, and (c) Fig. \ref{fig:study-stru-my}}
\end{figure}
...
The result of four-battery structure has been shown in Tab. \ref{tab:study-results-my}, Fig. \ref{fig:e2f2-mac}, and Fig. \ref{fig:e2f2-alg}. 
The structures and final switch-control schemes of the others are shown in Figs. \ref{fig:e2f1-mac} and \ref{fig:e2f3-mac}, respectively. 
And the temporal variation of the objective values during the iteration process are shown in Figs. \ref{fig:e2f1-alg} and \ref{fig:e2f3-alg}, respectively.
...
To validate the proposed algorithm's effectiveness in the scenario of unhealthy batteries, the RBS with isolated batteries is also taken into consideration and calculated. 
For the four-battery RBS structure shown in Fig. \ref{fig:study-stru-my}, there are four possible cases of isolated batteries: (a) only one unhealthy battery, (b) two unhealthy batteries which are separated in the two subsections, (c) two batteries located in the same subsection, and (d) three batteries. 
The final calculated MAC($\eta$)s of these four cases are 2, 2, 1, and 1, respectively.
And the corresponding switch-control schemes of these four cases are shown in Figs. \ref{fig:my-isolated-1}--\ref{fig:my-isolated-3}.
