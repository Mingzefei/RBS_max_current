...
\begin{abstract}
    ...
    In this paper, we propose a calculation method for the MAC of an RBS using a greedy algorithm in conjunction with a directed graph model of the RBS.
    ...
    The results demonstrate the viability of this method and its potential in facilitating next-generation RBS designs and applications, including battery isolation.
...
% \end{tikzpicture}
    \centering
    \begin{subfigure}[b]{0.8\textwidth}
        \includegraphics[width=\textwidth]{../attachments/main.png} % 替换用
        \caption{}
        \label{fig:main}
    \end{subfigure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{../attachments/isolated_mac.png}
    \caption{
