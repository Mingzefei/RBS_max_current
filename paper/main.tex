...
\begin{abstract}
    ...
    During the operation of the RBS, the Maximum Allowable Current (MAC) is a critical indicator to guide the system's reconfiguring control, ensuring safety and reliability.
    In this paper, we propose a calculation method for the MAC of arbitrary RBS using a greedy algorithm in conjunction with a directed graph model of the RBS.
    By employing the directed graph model, the greedy algorithm guides the RBS to establish parallel connections among batteries, aiming to maximize the system's output current while ensuring that none of the batteries are overloaded or short-circuited.
    The effectiveness of this method is validated on a novel and complex RBS structure.
    The results demonstrate the effectiveness of this method and its potential in facilitating next-generation RBS designs and applications, including battery isolation.
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{stru-V-origin} % 完整结构
        \caption{}
        \label{fig:stru-Visairo}
    \end{subfigure}
    \hspace{0.05\textwidth}
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{stru-V-serial} % 全串联
        \caption{}
        \label{fig:stru-Visairo-serial}
    \end{subfigure}
    \\
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{stru-V-parallel} % 全并联
        \caption{}
        \label{fig:stru-Visairo-parallel}
    \end{subfigure}
    \hspace{0.05\textwidth}
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{stru-V-isolate} % 电池隔离 右二 B3 全并联
        \caption{}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \includegraphics[width=\textwidth]{direct-graph-he}
        \caption{}
        \label{fig:direct-graph-he}
    \end{subfigure}
    \hspace{0.02\textwidth}
    \begin{subfigure}[b]{0.23\textwidth}
        \includegraphics[width=\textwidth]{direct-graph-xu}
        \caption{}
        \label{fig:direct-graph-xu}
    \end{subfigure}
    \hspace{0.02\textwidth}
    \begin{subfigure}[b]{0.24\textwidth}
        \includegraphics[width=\textwidth]{direct-graph-my}
        \caption{}
        \label{fig:direct-graph-my}
    \end{subfigure}
    \\
    \begin{subfigure}[b]{0.8\textwidth}
        \includegraphics[width=\textwidth]{battery_simple}
        \caption{}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{stru-L-origin}
        \caption{}
    ...
    \hspace{0.02\textwidth}
    \begin{subfigure}[b]{0.31\textwidth}
        \includegraphics[width=\textwidth]{stru-my-origin}
        \caption{}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.28\textwidth}
        \includegraphics[width=\textwidth]{ef-topo}
        \caption{}
        \label{fig:study-dirgraph-my}
    \end{subfigure}
    \hspace{0.05\textwidth}
    \begin{subfigure}[b]{0.28\textwidth}
        \includegraphics[width=\textwidth]{ef-sp1}
        \caption{}
        \label{fig:sp1}
    \end{subfigure}
    \hspace{0.05\textwidth}
    \begin{subfigure}[b]{0.28\textwidth}
        \includegraphics[width=\textwidth]{ef-sp2}
        \caption{}
        \label{fig:sp2}
    \end{subfigure}
    \\
    \begin{subfigure}[b]{0.28\textwidth}
        \includegraphics[width=\textwidth]{ef-sp3}
        \caption{}
        \label{fig:sp3}
    \end{subfigure}
    \hspace{0.05\textwidth}
    \begin{subfigure}[b]{0.28\textwidth}
        \includegraphics[width=\textwidth]{ef-sp4}
        \caption{}
        \label{fig:sp4}
    \end{subfigure}
    \hspace{0.05\textwidth}
    \begin{subfigure}[b]{0.28\textwidth}
        \includegraphics[width=\textwidth]{ef-mac}
        \caption{}
...
To illustrate this point, the MACs of the three RBS structures mentioned above are calculated after the batteries are isolated, as shown in Tab.\ref{tab:isolated_mac}. 
...
Furthermore, the performance of output current for the three RBS when isolating batteries is also shown in Tab.\ref{tab:isolated_mac}. 
...
\cmidrule{2-4}          & our  & Visairo's  & Lawson's  \\
    ...
    \end{tabular}
    \\
    \footnotesize{$^{\rm a}$ isolate two batteries within the same substructure, as shown in Fig.\ref{fig:my-isolated-2b}}\\
    \footnotesize{$^{\rm b}$ isolate one battery in each of the two substructures, as shown in Fig.\ref{fig:my-isolated-2w}}
\end{table}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.31\textwidth}
        \includegraphics[width=\textwidth]{my-isolated-1}
        \caption{}
        \label{fig:my-isolated-1}
    \end{subfigure}
    \hspace{0.02\textwidth}
    \begin{subfigure}[b]{0.31\textwidth}
        \includegraphics[width=\textwidth]{my-isolated-2b}
        \caption{}
        \label{fig:my-isolated-2b}
    \end{subfigure}
    \\
    \begin{subfigure}[b]{0.31\textwidth}
        \includegraphics[width=\textwidth]{my-isolated-2w}
        \caption{}
    ...
    \end{subfigure}
    \caption{
        The circuit states of MACs when isolating (a)one, (b)two(best case), (c)two(worst case) and (d)three batteries for the structure in Fig.\ref{fig:study-stru-my}.
        }
\end{figure}
